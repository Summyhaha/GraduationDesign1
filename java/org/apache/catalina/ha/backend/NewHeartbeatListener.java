 ...
 * BTW:v  = version :-)
 */
public class NewHeartbeatListener implements LifecycleListener, ContainerListener {

    private static final Log log = LogFactory.getLog(NewHeartbeatListener.class);
    ...
    public void lifecycleEvent(LifecycleEvent event) {
        ...
        if (Lifecycle.PERIODIC_EVENT.equals(event.getType())) {
            if (sender == null) {
                if (proxyList == null)
                    sender = new NewMultiCastSender();
                else
                    sender = new NewTcpSender();
            }
