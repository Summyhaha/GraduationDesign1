...
import org.apache.catalina.ha.NewClusterMessageBase;
 ...
 */
public class NewSessionMessageImpl extends NewClusterMessageBase implements NewSessionMessage {
    ...
    private NewSessionMessageImpl( String contextName,
                           int eventtype,
                           byte[] session,
                           String sessionID)
    {
     ...
     */
    public NewSessionMessageImpl( String contextName,
                           int eventtype,
                           byte[] session,
                           String sessionID,
                           String uniqueID)
