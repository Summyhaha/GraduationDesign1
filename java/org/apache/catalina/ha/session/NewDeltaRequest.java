...
public class NewDeltaRequest implements Externalizable {

    public static final org.apache.juli.logging.Log log =
        org.apache.juli.logging.LogFactory.getLog( NewDeltaRequest.class );
    ...
    public NewDeltaRequest() {

    }

    public NewDeltaRequest(String sessionId, boolean recordAllActions) {
    ...
    public void execute(NewDeltaSession session, boolean notifyListeners) {
     ...
     * @see NewDeltaRequest#writeExternal(java.io.ObjectOutput)
     *
