 ...
 *@version 1.0
 */
public class NewBackupManager extends NewClusterManagerBase
        implements MapOwner, DistributedManager {

    private final Log log = LogFactory.getLog(NewBackupManager.class);
...
//******************************************************************************/
    ...
    @Override
    public void messageDataReceived(NewClusterMessage msg) {
    }
...
//=========================================================================
    ...
    public NewClusterManager cloneFromTemplate() {
        NewBackupManager result = new NewBackupManager();
        clone(result);
