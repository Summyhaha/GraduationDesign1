 ...
 */
public class NewJvmRouteBinderValve extends ValveBase implements NewClusterValve {

    /*--Static Variables----------------------------------------*/
    public static final org.apache.juli.logging.Log log = org.apache.juli.logging.LogFactory
            .getLog(NewJvmRouteBinderValve.class);

    //------------------------------------------------------ Constructor
    public NewJvmRouteBinderValve() {
        super(true);
    }
     ...
     * the cluster
     */
    protected NewCatalinaCluster cluster;
    ...
    public void invoke(Request request, Response response) throws IOException,
         ...
         if (getEnabled() &&
             ...
             if (manager != null && (
                     (manager instanceof NewClusterManager
                       && getCluster() != null
                       && getCluster().getManager(((NewClusterManager)manager).getName()) != null)
                     ||
     ...
     *
     * @see NewJvmRouteBinderValve#handleJvmRoute(Request, String, String)
    ...
    protected synchronized void startInternal() throws LifecycleException {
        ...
        if (cluster == null) {
            ...
            if (hostContainer instanceof Host
                ...
                cluster = (NewCatalinaCluster) ((Host) hostContainer).getCluster();
            } else {
                Container engine = hostContainer.getParent() ;
                if (engine instanceof Engine
                        && ((Engine) engine).getCluster() != null) {
                    cluster = (NewCatalinaCluster) ((Engine) engine).getCluster();
                }
            }
        }
