...
import org.apache.catalina.ha.NewClusterManager;
import org.apache.catalina.ha.NewClusterMessage;
 ...
 */
public class NewDeltaManager extends NewClusterManagerBase{

    // ---------------------------------------------------- Security Classes
    public final org.apache.juli.logging.Log log =
            org.apache.juli.logging.LogFactory.getLog(NewDeltaManager.class);
    ...
    private final ArrayList<NewSessionMessage> receivedMessageQueue =
            new ArrayList<>();
    ...
    protected void sendCreateSession(String sessionId, DeltaSession session) {
        if(cluster.getMembers().length > 0 ) {
            NewSessionMessage msg =
                new NewSessionMessageImpl(getName(),
                                       NewSessionMessage.EVT_SESSION_CREATED,
                                       null,
                                       sessionId,
     ...
     */
    protected void send(NewSessionMessage msg) {
        if(cluster != null) {
            cluster.send(msg);
        }
    }
    ...
    protected void sendChangeSessionId(String newSessionID, String orgSessionID) {
        if (cluster.getMembers().length > 0) {
            try {
                ...
                NewSessionMessage msg = new NewSessionMessageImpl(getName(),
                        NewSessionMessage.EVT_CHANGE_SESSION_ID, data,
    ...
    public synchronized void getAllClusterSessions() {
        if (cluster != null && cluster.getMembers().length > 0) {
            ...
            NewSessionMessage msg = new NewSessionMessageImpl(this.getName(),
                    NewSessionMessage.EVT_GET_ALL_SESSIONS, null, "GET-ALL", "GET-ALL-" + getName());
            ...
            try {
                ...
                synchronized(receivedMessageQueue) {
                    for (Iterator<NewSessionMessage> iter = receivedMessageQueue.iterator();
                            iter.hasNext();) {
                        NewSessionMessage smsg = iter.next();
                        if (!stateTimestampDrop) {
                            messageReceived(smsg,
                                    smsg.getAddress() != null ? (Member) smsg.getAddress() : null);
                        } else {
                            if (smsg.getEventType() != NewSessionMessage.EVT_GET_ALL_SESSIONS &&
     ...
     */
    @Override
    public void messageDataReceived(NewClusterMessage cmsg) {
        if (cmsg != null && cmsg instanceof NewSessionMessage) {
            NewSessionMessage msg = (NewSessionMessage) cmsg;
            switch (msg.getEventType()) {
                case NewSessionMessage.EVT_GET_ALL_SESSIONS:
                case NewSessionMessage.EVT_SESSION_CREATED:
                case NewSessionMessage.EVT_SESSION_EXPIRED:
                case NewSessionMessage.EVT_SESSION_ACCESSED:
                case NewSessionMessage.EVT_SESSION_DELTA:
                case NewSessionMessage.EVT_CHANGE_SESSION_ID:
                    synchronized(receivedMessageQueue) {
                        if(receiverQueue) {
     ...
     */
    @Override
    public NewClusterMessage requestCompleted(String sessionId) {
      ...
      * @return a SessionMessage to be sent,
      */
     public NewClusterMessage requestCompleted(String sessionId, boolean expires) {
        ...
        try {
            ...
            synchronized(deltaRequest) {
                ...
                if (isDeltaRequest) {
                    ...
                    msg = new NewSessionMessageImpl(getName(),
                                                 NewSessionMessage.EVT_SESSION_DELTA,
                                                 data,
                                                 sessionId,
                                                 sessionId + "-" + System.currentTimeMillis());
                    session.resetDeltaRequest();
            ...
            if(!isDeltaRequest) {
                if(!expires && !session.isPrimarySession()) {
                    ...
                    msg = new NewSessionMessageImpl(getName(),
                                                 NewSessionMessage.EVT_SESSION_ACCESSED,
                                                 null,
                                                 sessionId,
                                                 sessionId + "-" + System.currentTimeMillis());
                    if (log.isDebugEnabled()) {
    ...
    protected void sessionExpired(String id) {
        if(cluster.getMembers().length > 0 ) {
            ...
            NewSessionMessage msg = new NewSessionMessageImpl(getName(),
                    NewSessionMessage.EVT_SESSION_EXPIRED, null, id, id+ "-EXPIRED-MSG");
            msg.setTimestamp(System.currentTimeMillis());
            if (log.isDebugEnabled()) {
     ...
     */
    protected boolean checkSenderDomain(NewSessionMessage msg,Member sender) {
     ...
     *            requesting node
     */
    protected void messageReceived(NewSessionMessage msg, Member sender) {
        ...
        try {
            ...
            switch (msg.getEventType()) {
                case NewSessionMessage.EVT_GET_ALL_SESSIONS:
                    ...
                    break;
                case NewSessionMessage.EVT_ALL_SESSION_DATA:
                    handleALL_SESSION_DATA(msg,sender);
                    break;
                case NewSessionMessage.EVT_ALL_SESSION_TRANSFERCOMPLETE:
                ...
                case NewSessionMessage.EVT_CHANGE_SESSION_ID:
                    ...
                    break;
                case NewSessionMessage.EVT_ALL_SESSION_NOCONTEXTMANAGER:
     ...
     * @param sender
     */
    protected void handleALL_SESSION_TRANSFERCOMPLETE(NewSessionMessage msg, Member sender) {
     ...
     * @throws ClassNotFoundException
     */
    protected void handleSESSION_DELTA(NewSessionMessage msg, Member sender)
     ...
     * @throws IOException
     */
    protected void handleSESSION_ACCESSED(NewSessionMessage msg,Member sender) throws IOException {
     ...
     * @throws IOException
     */
    protected void handleSESSION_EXPIRED(NewSessionMessage msg,Member sender) throws IOException {
     ...
     * @param sender
     */
    protected void handleSESSION_CREATED(NewSessionMessage msg,Member sender) {
     ...
     * @throws IOException
     */
    protected void handleALL_SESSION_DATA(NewSessionMessage msg,Member sender)
            throws ClassNotFoundException, IOException {
     ...
     * @throws IOException
     */
    protected void handleGET_ALL_SESSIONS(NewSessionMessage msg, Member sender) throws IOException {
        ...
        NewSessionMessage newmsg = new NewSessionMessageImpl(name,
                NewSessionMessage.EVT_ALL_SESSION_TRANSFERCOMPLETE, null, "SESSION-STATE-TRANSFERED",
     ...
     * @throws IOException
     */
    protected void handleCHANGE_SESSION_ID(NewSessionMessage msg,Member sender) throws IOException {
     ...
     * @param sender
     */
    protected void handleALL_SESSION_NOCONTEXTMANAGER(NewSessionMessage msg, Member sender) {
    ...
    protected void sendSessions(Member sender, Session[] currentSessions,long sendTimestamp)
        ...
        NewSessionMessage newmsg = new NewSessionMessageImpl(name, NewSessionMessage.EVT_ALL_SESSION_DATA,
    ...
    @Override
    public NewClusterManager cloneFromTemplate() {
        NewDeltaManager result = new NewDeltaManager();
        clone(result);
