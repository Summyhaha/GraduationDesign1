 ...
 */
public class NewSerializablePrincipal  implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    private static final org.apache.juli.logging.Log log =
        org.apache.juli.logging.LogFactory.getLog(NewSerializablePrincipal.class);
     ...
     */
    public NewSerializablePrincipal(String name, String password,
    ...
    public static NewSerializablePrincipal createPrincipal(GenericPrincipal principal)
    {
        if ( principal==null) return null;
        return new NewSerializablePrincipal(principal.getName(),
