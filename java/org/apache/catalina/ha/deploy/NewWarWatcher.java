 ...
 * @version 1.1
 */
public class NewWarWatcher {

    /*--Static Variables----------------------------------------*/
    private static final Log log = LogFactory.getLog(NewWarWatcher.class);
     ...
     */
    protected final NewFileChangeListener listener;
    ...
    public NewWarWatcher(NewFileChangeListener listener, File watchDir) {
