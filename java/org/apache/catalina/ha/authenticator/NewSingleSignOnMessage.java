...
public class NewSingleSignOnMessage implements NewClusterMessage {
    ...
    private NewSerializablePrincipal principal = null;

    private Member address = null;
    private long timestamp = 0;
    private String uniqueId = null;

    public NewSingleSignOnMessage(Member source,
                               String ssoId,
                               String sessionId) {
        this.address = source;
        this.ssoId = ssoId;
    ...
    public NewSerializablePrincipal getPrincipal() {
        return principal;
    }

    public void setPrincipal(NewSerializablePrincipal principal) {
