 ...
 */
public class NewClusterSingleSignOnListener extends NewClusterListener {

    private static final Log log =
        LogFactory.getLog(NewClusterSingleSignOnListener.class);

    // ------------------------------------------------------------- Properties

    private final NewClusterSingleSignOn clusterSSO;


    //--Constructor---------------------------------------------

    public NewClusterSingleSignOnListener(NewClusterSingleSignOn clusterSSO) {
     ...
     *
     * @param myobj
     *            NewClusterMessage - the message received from the cluster
     */
    @Override
    ...
    private Session getSession(String sessionId, String ctxname) {
        ...
        Map<String,NewClusterManager> managers = clusterSSO.getCluster().getManagers();
        Session session = null;

        if (ctxname == null) {
            for (Map.Entry<String, NewClusterManager> entry : managers.entrySet()) {
